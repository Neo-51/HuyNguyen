...
<?php if ( mikael_get_theme_mod( 'popup_cf7_shortcode' ) ) : ?>

	<div class="modal fade" id="vlt-contact-form" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-body">
					<button type="button" class="close" data-dismiss="modal" aria-label="<?php esc_html_e( 'Close', 'mikael' ); ?>">
					...
					<?php echo do_shortcode( html_entity_decode( mikael_get_theme_mod( 'popup_cf7_shortcode' ) ) ); ?>
				</div>
			</div>
		</div>
	</div>
