...
<div class="vlt-offcanvas-menu">
	...
	<div class="vlt-offcanvas-menu__footer">
			...
			<div class="vlt-offcanvas-menu__socials">
				...
				<?php
					foreach ( mikael_get_theme_mod( 'offcanvas_menu_socials_list' ) as $socialItem ) :
						echo '<a href="' . esc_url( $socialItem[ 'social_url' ] ) . '" target="_blank">' . esc_html( $socialItem[ 'social_text' ] ) . '</a>';
					endforeach;
				?>
		...
		<?php if ( mikael_get_theme_mod( 'offcanvas_menu_copyright' ) ) : ?>
			...
			<div class="vlt-offcanvas-menu__copyright"><?php echo wp_kses_post( mikael_get_theme_mod( 'offcanvas_menu_copyright' ) ); ?></div>
