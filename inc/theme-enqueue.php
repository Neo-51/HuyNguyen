 ...
 * Enqueue assets
 */
if ( ! class_exists( 'MikaelEnqueueAssets' ) ) {
	class MikaelEnqueueAssets {
		...
		public function enqueue_frontend_scripts() {
			...
			wp_enqueue_script( 'jarallax-video', $this->assets_dir . 'vendors/jarallax-video.min.js', [ 'jquery' ], $this->theme_version, true );
		...
		public function enqueue_frontend_styles() {
			...
			wp_enqueue_style( 'superfish', $this->assets_dir . 'css/plugins/animate.min.css', [], $this->theme_version );
